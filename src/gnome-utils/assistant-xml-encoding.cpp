/**********************************************************************
 * assistant-xml-encoding.cpp -- Coversion of old XML file
...
{
    conv_type *new_conv = NULL;
    if (conv)
    {
        new_conv = g_new(conv_type, 1);
        new_conv->encoding = conv->encoding;
        new_conv->utf8_string = g_strdup (conv->utf8_string);
    }
    return new_conv;
}
