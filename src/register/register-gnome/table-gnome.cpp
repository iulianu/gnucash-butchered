/********************************************************************\
 * table-gnome.cpp -- implementation of table object in GNOME       *
 *                                                                  *
...
/* Um, this function checks that data is not null but never uses it.
   ...
   widget, maybe some of it should be moved to gnucash-sheet.cpp. */
/* Adding to previous note:  Since data doesn't appear do anything and to 
   ...
   NULL and changed two calls in dialog_order.cpp and dialog_invoice.cpp 
