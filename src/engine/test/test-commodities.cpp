...
test_commodity(void)
{
...

    {
        ...
        comm_namespace = get_random_commodity_namespace();
        mnemonic = get_random_string();
        cusip = get_random_string();
        fraction = get_random_int_in_range(0, 10000);

        com = gnc_commodity_new(book, fullname, comm_namespace, mnemonic,
                                cusip, fraction);
        ...
        do_test(
            g_strcmp0(comm_namespace, gnc_commodity_get_namespace(com)) == 0,
        ...
        comm_namespace = get_random_commodity_namespace();
        gnc_commodity_set_namespace(com, comm_namespace);
        do_test(
            g_strcmp0(comm_namespace, gnc_commodity_get_namespace(com)) == 0,
        ...
        com2 = gnc_commodity_new(book, fullname, comm_namespace, mnemonic,
                                 cusip, fraction);
        do_test(
